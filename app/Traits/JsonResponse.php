 ...
 * Trait ApiResponse
 *
 * Centralise toutes les réponses JSON d'une API Laravel.
 * À utiliser dans les Controllers, Services, ou tout autre classe.
 *
 * Usage dans un Controller :
 *   use App\Http\Traits\ApiResponse;
 *
 * Usage dans un Service (injection du trait) :
 *   use App\Http\Traits\ApiResponse;
 */
trait JsonResponse
{
